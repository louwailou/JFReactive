...
@implementation JFGraphicContrller
...
- (void)addAnimationOneOnLayer:(CAShapeLayer *)layer duration:(CFTimeInterval)duration
{
    ...
    // 如果是strokenEnd fromValue endValue 只是取第一个值
    animation.fromValue = @[@0,@0.5];
    animation.toValue = @[@0.2,@1.0];
